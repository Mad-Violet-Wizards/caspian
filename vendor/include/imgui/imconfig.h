...
//         return sf::Vector2<T>(x + rhs, y + rhs);                                                   \
//     }                                                                                              \
//                                                                                                    \
//     template<typename T>                                                                           \
//     operator- (const T& rhs) const {                                                               \
...
//         return sf::Vector2<T>(x / rhs, y / rhs);                                                   \
//     }                                                                                              \
//     /* Scalars end, SFML vec start */                                                              \
//     template<typename T>                                                                           \
//     operator+ (const sf::Vector2<T>& rhs) const {                                                  \
//         return sf::Vector2<T>(x + rhs.x, y + rhs.y);                                               \
//     }                                                                                              \
//                                                                                                    \
//     template<typename T>                                                                           \
//     operator- (const sf::Vector2<T>& rhs) const {                                                  \
...
//         return sf::Vector2<T>(x / rhs.x, y / rhs.y);                                               \
//     }                                                                                              \
//     /* SFML vec end, imgui vec start */                                                            \
//     template<typename T>                                                                           \
//     operator+ (const ImVec2& rhs) const {                                                          \
//         return sf::Vector2<T>(x + rhs.x, y + rhs.y);                                               \
//     }                                                                                              \
//                                                                                                    \
//     template<typename T>                                                                           \
...
// To be able to create extra constructor for ImVec2 struct in imgui.h.
#define IM_VEC2_CLASS_EXTRA                                                         \
                                                                                    \
    /* Scalars */                                                                   \
